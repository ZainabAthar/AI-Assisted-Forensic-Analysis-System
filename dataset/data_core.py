...
from dataset.dataset_CocoGlide import CocoGlide  # Add this at the top
...
class myDataset(Dataset):
    def __init__(self, config, crop_size, grid_crop, mode="train", max_dim=None, aug=None):
        ...
        if mode == "train":
            ...
            if 'CocoGlide' in training_set:
                self.dataset_list.append(CocoGlide(crop_size, grid_crop, "dataset/data/CocoGlide_train_list.txt", aug=aug))
            ...
            if 'CocoGlide' in valid_set:
                self.dataset_list.append(CocoGlide(crop_size, grid_crop, "dataset/data/CocoGlide_valid_list.txt", max_dim=max_dim, aug=aug))
